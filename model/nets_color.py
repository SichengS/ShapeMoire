...
class my_model(nn.Module):
    def __init__(self,
        ...
        self.rescolor = ResColor(in_channels = 3, out_channels = 3)
        
        
    def forward(self, x):
        y_1, y_2, y_3 = self.encoder(x)
        mid_1, mid_2, mid_3 = self.decoder(y_1, y_2, y_3)

        out_1 = self.rescolor(mid_1)
        out_2 = self.rescolor(mid_2)
        out_3 = self.rescolor(mid_3)
        
        return mid_1, mid_2, mid_3, out_1, out_2, out_3
...
class ResColor(nn.Module):
    def __init__(self, in_channels, out_channels):
        super(ResColor, self).__init__()
        self.Block1 = BasicBlock(in_channels, out_channels)
        self.Block2 = BasicBlock(in_channels, out_channels)
